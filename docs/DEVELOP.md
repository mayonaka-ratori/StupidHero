...
やることと質問は`docs/BOARD.md`の表から読みます。作業をする人(AIも)は、作業を始めるときと終わるときにこの表を直し、人に決めてほしいことは「質問」に足します。Claude Codeのセッションでは、作業の区切りでダッシュボードを作り直してArtifactとして公開すると、スマホで見られます。
