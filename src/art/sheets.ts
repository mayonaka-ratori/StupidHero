...
export const SHEETS: SheetDef[] = [
  ...
  { key: 'fx_psy_items', frameW: 12, frameH: 12, cols: 8, anchor: 'center',
    rows: [a('item', 8, 1, false, '机の上と会場の小物。0:ペン、1:名刺、2:マグカップ、3:グラス、4:ナプキン、5:キャンドル、6:ケーキ、7:肉料理(6と7は白い皿にのせた料理。コマを選んで止めて使う)')] },
