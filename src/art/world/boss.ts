...
function bossHead(face: BossFace): HeadArt {
  ...
  // 鼻の下とあごの影
  put([[17, 13], [18, 13]], sh);
  put([[15, 18], [16, 18], [17, 17]], sh);
  // 眉(太い)と目
  if (face === 'hurt') {
    // 目をぎゅっとつぶる(しわを寄せる)
    put([[13, 9], [14, 10], [15, 10], [16, 10], [17, 9]], o);
    put([[13, 8], [14, 8], [16, 8], [17, 8]], sh);
  } else if (face === 'ko') {
    // 目を回す(×)
    put([[13, 9], [15, 9], [14, 10], [13, 11], [15, 11]], o);
    put([[13, 8], [14, 8], [15, 8], [16, 8]], sh);
  } else {
    // 怒った眉:前へ下がる。その下に目
    put([[11, 7], [12, 7], [13, 8], [14, 8], [15, 8], [16, 9], [17, 9], [12, 8], [14, 9], [15, 9]], o);
    put([[13, 10], [14, 10]], wt);
    put([[15, 10], [16, 10]], o);
    if (face === 'shout') put([[13, 10], [14, 10], [15, 10]], wt);
    put([[13, 11], [14, 11], [15, 11]], sh);
    put([[17, 10], [18, 10]], sh);
  }
  // 口
  if (face === 'grim') { put([[15, 15], [16, 15], [17, 15]], o); put([[14, 16]], o); put([[15, 16], [16, 16]], sh); }
  if (face === 'grin') {
    put([[14, 14], [15, 15], [16, 15], [17, 15], [18, 14]], o);
    put([[15, 16], [16, 16], [17, 16]], o);
    put([[15, 15], [16, 15], [17, 15]], wt);
  }
  if (face === 'shout' || face === 'hurt') {
    put([[15, 14], [16, 14], [17, 14], [18, 14], [14, 15], [14, 16], [15, 17], [16, 17], [17, 17]], o);
    put([[15, 15], [16, 15], [17, 15]], wt);
    put([[15, 16], [16, 16], [17, 16], [18, 15], [18, 16]], dk);
  }
  if (face === 'ko') {
    put([[15, 15], [16, 15], [17, 15], [14, 16]], o);
    put([[16, 16], [17, 16]], VEST[0]);
    P.px(16, 17, o).px(17, 17, o);
  }
  // 金の耳飾り
...
function drawBoss(pose0: BPose, face: BossFace, scraps = 0): PixelGrid {
  ...
  drawTorso(P, pose);
  drawNeckAndHead(P, pose, bossHead(face), 5, SKIN);
