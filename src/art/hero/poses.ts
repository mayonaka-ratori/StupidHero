...
// ---------- 4 踏みつぶし ----------
const stomp: Pose[] = [
  P({ lean: 22, squash: 0.1, face: 'normal', af: { a: -70, e: 20 }, ab: { a: -50, e: 30 },
    lf: { a: 55, k: 115 }, lb: { a: 75, k: 120 }, cape: capeIdle(0.3), tail: { a: -40, ph: 0 } }),
  P({ ground: false, y: 33, lean: -4, face: 'grin', af: { a: -150, e: 10 }, ab: { a: 165, e: 10 },
  ...
  P({ ground: false, y: 32, lean: -6, face: 'shout', af: { a: -140, e: -20, hand: 'fist' }, ab: { a: 160, e: -10 },
...
// ---------- 5 必殺技 ----------
const holdHands: Partial<Pose> = { af: { a: -62, e: 40, hand: 'open', ha: 40 }, ab: { a: -50, e: 40, hand: 'open', ha: 40 } };
const special: Pose[] = [
  P({ lean: -4, face: 'normal', ...holdHands, lf: { a: -26, k: 10 }, lb: { a: 30, k: 30 }, cape: capeIdle(0) }),
...
// ---------- 7 待てで止まる:急ブレーキ → 敬礼 ----------
const SALUTE: Arm = { a: 100, e: 98, hand: 'flat', ha: 205 };
const stop: Pose[] = [
  ...
  P({ lean: -4, face: 'grin', af: SALUTE, ab: HANG_B,
    lf: { a: -3, k: 0 }, lb: { a: 4, k: 0 }, cape: { a: -4, len: 30, ph: 4.5, w: 9 }, tail: { a: -30, ph: 3 } }),
  P({ lean: -4, face: 'wink', af: SALUTE, ab: HANG_B,
...
const oops: Pose[] = [
  ...
  P({ lean: -34, face: 'oops', armRel: true, af: HOLD_F, ab: HOLD_B,
    lf: { a: -20, k: 10 }, lb: { a: 70, k: 90 }, cape: { a: -35, len: 30, ph: 3, w: 11 }, tail: { a: -40, ph: 3 } }),
  P({ lean: -30, face: 'oops', armRel: true, af: HOLD_F, ab: HOLD_B,
    lf: { a: -18, k: 10 }, lb: { a: 60, k: 80 }, cape: { a: -30, len: 30, ph: 4.5, w: 11 }, tail: { a: -35, ph: 4.5 } }),
  P({ lean: -34, face: 'oops', armRel: true, af: HOLD_F, ab: HOLD_B,
    lf: { a: -20, k: 10 }, lb: { a: 70, k: 90 }, cape: { a: -35, len: 30, ph: 6, w: 11 }, tail: { a: -40, ph: 6 } })
];
...
const okay: Pose[] = [
  ...
  P({ lean: -6, face: 'grin', af: HIP_F, ab: { a: 165, e: 15, hand: 'fist' },
...
const winPose: Pose[] = [0, 1].map((i) => P({
  lean: -3, face: 'grin', af: { a: 128, e: 0, hand: 'point' }, ab: HIP_B,
  lf: { a: -26, k: 0 }, lb: { a: 28, k: 8 },
  cape: { a: -42, len: 29, ph: i * 3, w: 10, amp: 2 }, tail: { a: -70, ph: i * 3 }
}));
const winArms: Pose[] = [0, 1].map((i) => P({
  lean: -6, face: 'smug', hy: -1,
  af: { a: 12, e: -102, hand: 'fist' }, ab: { a: 30, e: 70, hand: 'fist' },
