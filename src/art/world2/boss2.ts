...
/** 白い毛皮(影は青みの灰色) */
const FUR = [md(7, 7, 7), md(6, 6, 7), md(4, 4, 6)] as const;
...
function bossHead(face: BossFace): HeadArt {
  ...
  if (face === 'ko') {
    ...
    // サングラスがずれて、ぎゅっとつぶった目がのぞく
    put([[16, 15], [17, 15], [18, 15], [19, 15], [20, 15], [21, 16], [22, 16], [23, 16], [24, 16], [25, 16]], o);
    put([[17, 16], [18, 16], [19, 16], [22, 17], [23, 17], [24, 17]], DRESS[2]);
    put([[17, 17], [18, 17], [19, 17], [20, 17]], o);
    put([[18, 16]], FUR[0]);
    put([[18, 13], [19, 14], [20, 14], [21, 13]], o);
  } else {
    // 紫のサングラス
    put([[16, 13], [17, 13], [18, 13], [19, 13], [20, 13], [21, 13], [22, 13], [23, 13], [24, 13], [25, 13]], o);
    put([[17, 14], [18, 14], [19, 14], [20, 14], [22, 14], [23, 14], [24, 14]], DRESS[2]);
    put([[17, 15], [18, 15], [19, 15], [23, 15], [24, 15]], DRESS[2]);
    put([[21, 14], [20, 15], [22, 15], [17, 16], [18, 16], [19, 16], [23, 16], [24, 16]], o);
    put([[17, 14], [18, 14], [23, 14]], FUR[1]);
    P.px(17, 14, FUR[0]);
  }
  // 口(赤い口紅)
...
function furTufts(P: Painter, m: Mask, dark: string, seed = 0): void {
  ...
  m.each((x, y) => {
    ...
    P.px(x, y, dark).px(x, y + 1, dark).px(x + 1, y + 2, dark);
  });
}
...
function fillFur(P: Painter, m: Mask, far: boolean, sep: 'outline' | 'dark' | 'none' = 'outline', seed = 0): void {
  ...
  shade(P, m, r, { sep, hi: 0.36, lo: 0.7 });
