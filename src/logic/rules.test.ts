...
describe('rules', () => {
  it('SPECの数字', () => {
    expect(WAVES.map((w) => [w.people, w.seconds])).toEqual([[5, 30], [5, 22], [5, 24]]);
    expect(PROP_COST).toMatchObject({ trash: 30000, window: 80000, sign: 150000, vending: 800000, car: 3000000 });
