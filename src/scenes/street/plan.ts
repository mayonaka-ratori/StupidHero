...
import { ACCESSORY_COLORS, GANG_COLOR_IDS, type GangLook, type Look, type Person, type PropKind, type Rng } from '../../logic';
...
export interface StreetPlan { people: PersonSpot[]; props: PropSpot[]; passers: PasserSpot[]; endX: number; gathers: GatherSpot[] }
