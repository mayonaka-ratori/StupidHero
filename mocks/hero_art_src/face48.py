...
def hero48(ek='normal', mouth='smirk', sweat=False, blush=False):
    ...
    # 首
    poly(g, [(21, 29), (30.5, 29), (30, 39), (26, 41), (22, 39)], lambda x, y: 'c' if y < 35 else 'b' if x > 26 else 'a')
    # 後ろ髪
    ell(g, 25, 18, 17, 16.5, lambda x, y: None if y > 30 else HR[min(3, shade3(x, y, 22, 14, 16, 16, (-0.35, 0.45)) + (1 if y > 24 else 0))])
    # 顔
    poly(g, [(14, 13), (38.5, 13), (39.5, 22), (38.5, 27.5), (36, 31.5), (31.5, 34.5), (27.5, 35.5), (24, 34.5), (19.5, 30.5), (15.5, 22)],
