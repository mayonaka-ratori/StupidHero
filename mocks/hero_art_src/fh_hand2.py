...
S = {
 ...
 19:[(3,"o223"),(7,"baaaaaaaaaaaaaaab"),(24,"o")],
 20:[(4,"o23"),(7,"obaaaaaaaaaaaaab"),(23,"o")],
 21:[(5,"oo"),(8,"obbaaaaaaaaab"),(21,"o")],
 22:[(9,"oocbbaaaabo")],
 23:[(11,"occbbbo")],
 24:[(11,"occbbbo")],
...
MOUTH = {
 'smirk':     [(19, 20, "o"), (20, 17, "ooo")],
 'smirkOpen': [(19, 18, "ooo"), (20, 17, "odRo"), (21, 18, "oo")],
 'wavy':      [(19, 17, ".o.o."), (20, 17, "o.o.o")],
 'wail':      [(18, 17, "ooo"), (19, 16, "odddo"), (20, 16, "odRdo"), (21, 17, "ooo")],
 'smile':     [(19, 16, "o...o"), (20, 17, "ooo")],
 'bigSmile':  [(19, 16, "ooooo"), (20, 16, "owwwo"), (21, 16, "odRdo"), (22, 17, "ooo")],
}
def hero_face(eye, mouth, sweat=False, blush=False):
    ...
    for y in range(4, 17):
        for x in range(1, 4):
            if g.c[y][x] == '3' and x < 3: g.c[y][x] = '2'
            elif g.c[y][x] == '2' and x == 1: g.c[y][x] = '1'
    g.put(MOUTH[mouth])
...
if __name__ == '__main__':
    for i, (e, m0, m1, kw) in enumerate(HERO_FACES):
        hero_face(e, m0, **kw).save(f'fhv{i}a.txt'); hero_face(e, m1, **kw).save(f'fhv{i}b.txt')
